    ...
    async def promo_slots_loop(self):
        ...
        while True:
            try:
                ...
                pass
            await asyncio.sleep(7200) # 11 minutes

    async def hindi_promo_loop(self):
        """Broadcasts all  tracks promo every 7 minutes."""
        msg = "🎵 BOOM 💥! 😎 Vibing to the your favourite tracks 🔥!  🎧 Request your anthem! 💖"
        while True:
            try:
                await self.highrise.chat(msg)
            except Exception:
                pass
            await asyncio.sleep(3600) # 7 minutes
